...
const mockCampaigns: Campaign[] = [
  {
    ...
    period: '2026.03.17 ~ 2026.03.31', creators: ['채도', '포백', '다빈'],
    products: ['KAIA 레이어드 세트', '오로라렌즈 콜라보 에디션', '율무톡스 버블팩'],
  ...
  },
  {
    ...
    period: '2026.04.08 ~ 2026.04.12', creators: ['승진', '리비'],
    products: ['한솥밥 떡갈비 도시락', '앰플엔 세럼 기획세트'],
    status: '종료', thumbnail: '💪', tag: '식품 기획전', description: '건강·식품 카테고리 집중 기획전. MG+RS 혼합 구조.',
  },
  {
    id: 'c03', title: '5월 패션 공구', subtitle: '여름 직전 패션 총집합',
    period: '2026.05.12 ~ 2026.05.24', creators: ['채도', '승진'],
    products: ['그린몬스터 콜라보 티셔츠', '플라이밀 프로틴바 10입'],
    status: '진행예정', thumbnail: '👗', tag: '시즌 기획전', description: '5월 패션·식품 복합 기획전. 채도·승진 양대 크리에이터 협업.',
  },
];
...
const mockBanners: Banner[] = [
  ...
  {
    id: 'b02', title: '두호 크리에이터 모집', image: '🎬',
...
// ── 상수 ──────────────────────────────────────────────
const CREATORS_LIST = ['레미니씬', '애정', '김체리', '진경', '이펠(최명)', '류스펜나', '켈리', '송수이', '뭉순임당', '인아짱', '채도', '포백', '다빈', '승진', '리비', '워니'];
const PRODUCTS_LIST = ['뉴치트 쉐이크', '율무톡스 버블팩', 'KAIA 레이어드 세트', '오로라렌즈 콜라보 에디션', '한솥밥 떡갈비 도시락', '앰플엔 세럼 기획세트', '그린몬스터 콜라보 티셔츠', '플라이밀 프로틴바 10입'];
